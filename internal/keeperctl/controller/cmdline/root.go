...
import (
	...
	"github.com/a-x-a/gophkeeper/internal/keeperctl/config"
	"github.com/a-x-a/gophkeeper/internal/keeperctl/controller/cmdline/editcmd"
	"github.com/a-x-a/gophkeeper/internal/keeperctl/controller/cmdline/pushcmd"
)
...
var (
	...
	rootCmd = &cobra.Command{
		Use:               "keeperctl",
		Short:             "keeperctl is an intercative commandline client for the goph-keeper service",
