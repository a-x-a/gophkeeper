...
func (uc *SecretsUseCase) PushBinary(
	...
	return uc.push(ctx, token, name, goph.DataKind_DATA_KIND_BINARY, description, data)
}
...
func (uc *SecretsUseCase) PushCard(
	...
	return uc.push(ctx, token, name, goph.DataKind_DATA_KIND_CARD, description, data)
}
...
func (uc *SecretsUseCase) PushCreds(
	...
	return uc.push(ctx, token, name, goph.DataKind_DATA_KIND_CREDENTIALS, description, data)
}
...
func (uc *SecretsUseCase) PushText(
	...
	return uc.push(ctx, token, name, goph.DataKind_DATA_KIND_TEXT, description, data)
}
...
func (uc *SecretsUseCase) Get(
	...
	case goph.DataKind_DATA_KIND_BINARY:
		msg = &goph.Binary{}
	case goph.DataKind_DATA_KIND_CARD:
		msg = &goph.Card{}
	case goph.DataKind_DATA_KIND_CREDENTIALS:
		msg = &goph.Credentials{}
	case goph.DataKind_DATA_KIND_TEXT:
		msg = &goph.Text{}
	}
